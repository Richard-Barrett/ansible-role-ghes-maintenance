...
HA upgrades additionally require `ghes_upgrade_ha_orchestrated: true`. The
`ha_preflight`, `ha_prepare`, and `ha_finalize` task entry points validate all
nodes and manage maintenance and replication around serial invocations of the
main role.
